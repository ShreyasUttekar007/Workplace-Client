...
const Form17 = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const documentUrl = momData.formDocument17
        ? await uploadFileToS3(momData.formDocument17, "form17")
        : null;

      const updatedMomData = {
        ...momData,
        formDocument17: documentUrl,
      };
      ...
      const response = await axios.post(
        "http://15.206.128.21:5000/api/form17/report",
        updatedMomData,
        {
          headers: {
