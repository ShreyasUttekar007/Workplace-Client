...
const MediaScan = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const momDataResponse = await axios.get(
          `http://15.206.128.21:5000/api/mediascan/get-mom/${userId}`,
          {
            headers: {
      ...
      if (value === initialDropdownValue) {
        ...
        if (name === "pc") {
          const responseMomByPC = await axios.get(
            `http://15.206.128.21:5000/api/mediascan/get-mom-by-pc/${value}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
          ...
          const responseMomByConstituency = await axios.get(
            `http://15.206.128.21:5000/api/mediascan/get-mom-by-constituency/${value}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
          ...
          const responseMomByZone = await axios.get(
            `http://15.206.128.21:5000/api/mediascan/get-mom-by-zone/${value}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
  ...
  const handleDeleteMom = async (momId) => {
    try {
      const token = await localforage.getItem("token");
      await axios.delete(
        `http://15.206.128.21:5000/api/mediascan/delete-mom/${momId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
    ...
    try {
      ...
      if (selectedZone === initialDropdownValue) {
        ...
        const responseZoneCount = await axios.get(
          `http://15.206.128.21:5000/api/mediascan/get-mom-count-by-zone/${selectedZone}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
    ...
    try {
      ...
      if (selectedPc === initialDropdownValue) {
        ...
        const responsePcCount = await axios.get(
          `http://15.206.128.21:5000/api/mediascan/get-mom-count-by-pc/${selectedPc}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
    ...
    try {
      ...
      if (selectedConstituency === initialDropdownValue) {
        ...
        const responseAcCount = await axios.get(
          `http://15.206.128.21:5000/api/mediascan/get-mom-count-by-constituency/${selectedConstituency}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
