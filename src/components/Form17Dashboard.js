...
const Form17Dashboard = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const momDataResponse = await axios.get(
          `http://15.206.128.21:5000/api/form17/get-report/${userId}`,
          {
            headers: {
      ...
      try {
        ...
        if (value === initialDropdownValue) {
          ...
          const responseMomByPC = await axios.get(
            `http://15.206.128.21:5000/api/form17/get-report-by-pc/${value}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
      ...
      try {
        ...
        if (value === initialDropdownValue) {
          ...
          const responseMomByConstituency = await axios.get(
            `http://15.206.128.21:5000/api/form17/get-report-by-constituency/${value}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
      ...
      try {
        ...
        if (value === initialDropdownValue) {
          ...
          const responseMomByZone = await axios.get(
            `http://15.206.128.21:5000/api/form17/get-report-by-zone/${value}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
  ...
  const handleDeleteMom = async (momId) => {
    try {
      const token = await localforage.getItem("token");
      await axios.delete(
        `http://15.206.128.21:5000/api/form17/delete-report/${momId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
